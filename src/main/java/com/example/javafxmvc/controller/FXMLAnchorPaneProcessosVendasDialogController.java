...
package com.example.javafxmvc.controller;
...
import com.example.javafxmvc.model.dao.ClienteDAO;
import com.example.javafxmvc.model.dao.ProdutoDAO;
import com.example.javafxmvc.model.database.Database;
import com.example.javafxmvc.model.database.DatabaseFactory;
import com.example.javafxmvc.model.domain.Cliente;
import com.example.javafxmvc.model.domain.ItemDeVenda;
import com.example.javafxmvc.model.domain.Produto;
import com.example.javafxmvc.model.domain.Venda;
...
public class FXMLAnchorPaneProcessosVendasDialogController implements Initializable {
    ...
    private boolean validarEntradaDeDados(){
        ...
        if (errorMessage.length() == 0) {
            ...
            alert.setHeaderText("campos inválidos, por favor, corriha...");
